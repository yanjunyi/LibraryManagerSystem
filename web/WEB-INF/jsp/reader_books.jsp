        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${books}" var="book">
                <tr>
                    ...
                    <c:if test="${flag}">
                        <td><a href="returnbook?bookId=<c:out value="${book.book_id}"></c:out>">
                            <button type="button" class="btn btn-danger btn-xs">归还</button>
                        </a></td>
                    </c:if>
                    <c:if test="${not flag}">
                        <c:if test="${book.number>0}">
                            <td><a href="lendbook?bookId=<c:out value="${book.book_id}"></c:out>">
                    ...
                    <td><a href="reader_book_detail?bookId=<c:out value="${book.book_id}"></c:out>">
